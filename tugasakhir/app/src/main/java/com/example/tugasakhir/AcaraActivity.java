...
import com.example.tugasakhir.databinding.ActivityAcaraBinding;
...
public class AcaraActivity extends BaseActivity {

    ActivityAcaraBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAcaraBinding.inflate(getLayoutInflater());
