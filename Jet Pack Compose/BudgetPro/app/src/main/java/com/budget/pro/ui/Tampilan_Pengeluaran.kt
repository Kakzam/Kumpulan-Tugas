...
import com.butget.pro.ui.Tampilan_Transaksi
                            ...
                            Modifier
                                ...
                                .clickable {
                                           if (rp.value.isEmpty()){
                                               ...
                                               FirebaseFirestore.getInstance().collection("BudgetPro").document(
                                                   Storage.getToken().toString()).collection("Pengeluaran").add(data)
