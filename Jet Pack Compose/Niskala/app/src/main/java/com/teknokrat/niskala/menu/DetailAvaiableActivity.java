...
public class DetailAvaiableActivity extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(DetailAvaiableActivity.this, (view, year1, month1, dayOfMonth) -> {
