...
class TampilanStatistik : ComponentActivity() {
                    ...
                    Column(
                        ...
                        if (pendapatan.value) {
                            FirebaseFirestore.getInstance().collection("BudgetPro")
                                .document(Storage.getToken().toString()).collection("Pendapatan")
                                .get()
                                .addOnSuccessListener {
                                    for (data in it.documents) {
                                        pendapatanH.value += data.data?.get("pendapatan").toString()
                                            .toBigDecimal()
                                    }
                        ...
                        if (pengeluaran.value) {
                            FirebaseFirestore.getInstance().collection("BudgetPro")
                                .document(Storage.getToken().toString()).collection("Pengeluaran")
                                .get()
                                .addOnSuccessListener {
                                    for (data in it.documents) {
                                        pengeluaranH.value += data.data?.get("pengeluaran")
                        ...
                        if (hutang.value) {
                            FirebaseFirestore.getInstance().collection("BudgetPro")
                                ...
                                .addOnSuccessListener {
                                    for (data in it.documents) {
                                        if (data.data?.get("status").toString()
                                                .equals("Belum Lunas")
                                        ) hutangH.value += data.data?.get("hutang").toString()
                                            .toBigDecimal()
                                    }
                            ...
                            FirebaseFirestore.getInstance().collection("BudgetPro")
                                ...
                                .addOnSuccessListener {
                                    for (data in it.documents) {
                                        if (data.data?.get("status").toString()
                                                .equals("Belum Lunas")
                                        ) piutangH.value += data.data?.get("piutang").toString()
                                            .toBigDecimal()
                                    }
                        ...
                        if (hitung.value) {
                            var itung =
                                pendapatanH.value + pengeluaranH.value + hutangH.value + piutangH.value
                        ...
                        Row(
                            ...
                            Image(
                                painterResource(R.drawable.rc_pendapatan), "",
                                Modifier
                                    .height(48.dp)
                                    .width(48.dp)
                                    .padding(4.dp)
                        ...
                        Row(
                            ...
                            Image(
                                painterResource(R.drawable.rc_pengeluaran), "",
                                Modifier
                                    .height(48.dp)
                                    .width(48.dp)
                                    .padding(4.dp)
                        ...
                        Row(
                            ...
                            Image(
                                painterResource(R.drawable.rc_hutang), "",
                                Modifier
                                    .height(48.dp)
                                    .width(48.dp)
                                    .padding(4.dp)
                        ...
                        Row(
                            ...
                            Image(
                                painterResource(R.drawable.rc_piutang), "",
                                Modifier
                                    .height(48.dp)
                                    .width(48.dp)
                                    .padding(4.dp)
