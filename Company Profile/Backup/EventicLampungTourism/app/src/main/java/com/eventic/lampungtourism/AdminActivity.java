    ...
    private class Tourism extends RecyclerView.Adapter<Tourism.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.buttonDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    firestore.collection("tourism").document(filter ? getFilterId.get(position) : getId.get(position)).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AdminActivity.this, "Silahkan periksa koneksi internet anda", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View v) {
                ...
                buttonDelete = v.findViewById(R.id.hapus);
            }
        }
    }
