...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root.findViewById(R.id.fragment_add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getContext(), TambahActivity.class).putExtra("COLLECTION", "KOST"));
            }
        });
        ...
        cloud.collection("KOST").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                } else Toast.makeText(getContext(), "Koneksimu mati cuy", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class ItemAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.binding.hapus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    cloud.collection("KOST").document(list.get(position).getDelete()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
