package com.faz.catering.ui.notifications;
...
import com.faz.catering.databinding.FragmentNotificationsBinding;
...
public class NotificationsAcaraFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.menuTambahCatering.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("NAME", "Acara");
                startActivity(intent);
            }
        });

        FirebaseFirestore.getInstance().collection("Acara").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
    ...
    private class CateringAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.binding.listHapus.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    FirebaseFirestore.getInstance().collection("Acara").document(db.get(position).getCatering()).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
